...
public interface UserService {
    ...
    //1. 常量，接口前面 #默认 public static final
    public static final int a = 1;

    //2. 普通方法 #默认public abstract
    public abstract String getUserName();

    //3. 默认方法，被子类继承，可以重写，也可以不重写 #默认public
    public default String getUserAge(){
        return null;
    }

    //4. 静态方法 只属于接口本身，不能被继承和重写 #默认public
...
- 局部内部类访问外部类的属性，外部类属性将默认转为fianl 修饰的常量。此变量被fianl 修饰后值无法改变。
